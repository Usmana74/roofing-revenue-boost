  ...
  return (
    ...
    >
      <div className="bg-[#0F172A] px-4 py-3 flex items-center gap-2.5">
        ...
        <span
          className="ml-auto text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md shrink-0"
          style={{
      ...
      <div className="bg-[#0F172A] p-5">
        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div>
              <div className="text-[11px] uppercase tracking-[0.1em] text-[#93C5FD] font-bold mb-1.5">
...
function Tile({
  label, value, sub, chart, chartColor,
}: {
  label: string; value: string; sub: string; chart?: number[]; chartColor?: string;
}) {
  return (
    <div
      ...
      <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          >
            ...
            Helping Roofing Companies Recover Missed Opportunities
          </motion.div>
          ...
          >
            Homeowners often contact multiple roofing companies and hire
            whoever responds first. We're testing a system designed to help
            roofing companies capture more opportunities and book more
            inspections.
          </motion.p>
          ...
          >
            {[
              ...
              <div key={item} className="flex items-center gap-2 text-[14px] text-[#64748B]">
    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-[1200px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-14 max-w-[760px] mx-auto">
          ...
          <h2
            className="font-extrabold text-[#0F172A] tracking-[-0.03em] leading-tight mb-4"
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {cards.map((c, i) => (
            ...
            >
              ...
              <div
                className="font-black tracking-[-0.03em] text-[#0F172A]"
        ...
        <motion.div {...fadeUp} className="mt-12 max-w-[720px] mx-auto text-center">
          <p className="text-[17px] text-[#475569] leading-[1.7]">
            The goal isn't more software. The goal is helping roofing companies capture
            opportunities that might otherwise go to competitors.
          </p>
        </motion.div>
      </div>
    </section>
      ...
      {events.map((e, i) => (
        <div key={i} className="flex gap-4">
          <div className="flex flex-col items-center shrink-0">
            ...
            {i < events.length - 1 && (
              <span className="w-px flex-1 mt-1 bg-[#E2E8F0]" style={{ minHeight: 24 }} />
            )}
          </div>
          <div className="pb-1">
            ...
            {e.sub && (
              <div className={`text-[13px] mt-0.5 ${e.subRed ? "text-[#DC2626] font-medium" : "text-[#64748B]"}`}>
                {e.sub}
              </div>
            )}
          </div>
    ...
    <section id="results" className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-[1200px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-14 max-w-[760px] mx-auto">
          ...
          <h2
            className="font-extrabold text-[#0F172A] tracking-[-0.03em] leading-tight"
            style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
          >
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          >
            <div
              className="flex items-center gap-3 px-6 py-4 bg-[#FEF2F2]"
              style={{ borderBottom: "1px solid #FEE2E2" }}
            >
              <span className="w-7 h-7 rounded-lg bg-[#EF4444] grid place-items-center">
            ...
            <div className="p-7">
              ...
              />
              <div
                className="mt-6 rounded-lg px-4 py-3 text-center text-[14px] font-bold text-[#991B1B]"
          ...
          >
            <div
              className="flex items-center gap-3 px-6 py-4 bg-[#ECFDF5]"
              style={{ borderBottom: "1px solid #A7F3D0" }}
            >
              <span className="w-7 h-7 rounded-lg bg-[#10B981] grid place-items-center">
            ...
            <div className="p-7">
              ...
              />
              <div
                className="mt-6 rounded-lg px-4 py-3 text-center text-[14px] font-bold text-[#065F46]"
        ...
        <motion.p
          {...fadeUp}
          className="text-center max-w-[560px] mx-auto mt-10 text-[15px] text-[#64748B] leading-[1.65]"
        >
...
export function HiddenCostSection() {
  const items = [
    {
      border: "#F59E0B", iconBg: "#FEF3C7", iconColor: "#D97706", Icon: Clock,
      title: "Owner on Inspection",
      body: "You're on a roof assessing storm damage. A homeowner just submitted a request on your website. They'll often wait only a short while before trying the next company.",
    },
    {
      border: "#EF4444", iconBg: "#FEF2F2", iconColor: "#DC2626", Icon: Truck,
      title: "Driving Between Jobs",
      body: "You're on the road managing crews. Missed calls go to voicemail. Some of those callers may already have someone coming out tomorrow.",
    },
    {
      border: "#2563EB", iconBg: "#EFF6FF", iconColor: "#2563EB", Icon: Users,
      title: "Managing Crews",
      body: "Material delivery, crew scheduling, job site issues — your attention goes where it's needed most. Following up on new leads in the moment isn't always possible.",
    },
  ];
  return (
    <section className="py-24 px-6 bg-white">
      <div className="max-w-[1200px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-14 max-w-[700px] mx-auto">
          ...
          <h2
            className="font-extrabold text-[#0F172A] tracking-[-0.03em] mb-4"
            style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
          >
            The Hidden Cost of Slow Follow-Up
          </h2>
          <p className="text-[17px] text-[#64748B]">
            Your team is out doing the work. Meanwhile, new opportunities sit waiting.
          </p>
        </motion.div>
        <div className="grid md:grid-cols-3 gap-5">
          {items.map((it, i) => (
            <motion.div
              ...
              style={{
                ...
                borderLeft: `4px solid ${it.border}`,
...
export function WhyPilotSection() {
  const bullets = [
    {
      Icon: Inbox,
      t: "How many opportunities are being lost",
      s: "Quantify the real gap between requests received and inspections booked.",
    },
    {
      Icon: Zap,
      t: "Whether faster engagement increases booked inspections",
      s: "Compare before/after response times against scheduled appointments.",
    },
    {
      Icon: DollarSign,
      t: "How much revenue can potentially be recovered",
      s: "Translate qualified opportunities into pipeline value, in your own numbers.",
    },
  ];
  return (
    <section id="why-pilot" className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-[960px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-12">
          ...
          <h2
            className="font-extrabold text-[#0F172A] tracking-[-0.03em] mb-5"
            style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
          >
            Why We're Running A Pilot
          </h2>
          <p className="text-[17px] text-[#475569] leading-[1.7] max-w-[720px] mx-auto">
            We believe many roofing companies lose opportunities simply because homeowners contact
            multiple contractors and often choose whoever responds first.
          </p>
        ...
        <motion.div
          {...fadeUp}
          className="mt-10 rounded-2xl p-7 text-center bg-white"
    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-[1200px] mx-auto" ref={ref}>
        <motion.div {...fadeUp} className="text-center mb-14">
          ...
          <h2
            className="font-extrabold text-[#0F172A] tracking-[-0.03em]"
            style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
          >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              big: <><CountStat value={78} isInView={inView} />%</>,
              size: "64px",
              desc: "of homeowners tend to choose a contractor that responds quickly",
            },
            {
              big: "$8k–18k",
              size: "40px",
              desc: "typical value of a residential roof replacement project",
            },
            {
              big: <><CountStat value={5} isInView={inView} />×</>,
              size: "64px",
              desc: "higher likelihood of booking when contacted within minutes",
            },
          ].map((s, i) => (
            <motion.div
              key={i}
            ...
            >
              <div
                className="font-black text-[#0F172A] tracking-[-0.03em] leading-none"
                style={{ fontSize: s.size }}
              >
                {s.big}
              </div>
              <div
                className="w-12 h-[3px] rounded-sm mx-auto mt-4"
...
export function HowItWorksSection() {
  const steps = [
    {
      Icon: Phone,
      title: "Estimate Request Comes In",
      body: "A homeowner finds you online, sees your truck, or gets a referral. They call or fill out a form. This moment is the starting point.",
    },
    {
      Icon: Zap,
      title: "Immediate Engagement",
      body: "We engage the homeowner quickly on your behalf, so they hear from your business while you're still their primary option.",
    },
    {
      Icon: CheckCircle,
      title: "Lead Qualification",
      body: "Job type, roof size, urgency, address, and timeline are confirmed. Your team gets a qualified lead — not a cold call back to a stranger.",
    },
    {
      Icon: CalendarDays,
      title: "Inspection Scheduled",
      body: "A date and time is agreed while the homeowner is engaged. The appointment lands on your calendar with no back-and-forth phone tag.",
    },
    {
      Icon: DollarSign,
      title: "More Inspections Won",
      body: "You show up to a scheduled inspection with someone who already knows your name — recovering an opportunity that might have gone to a competitor.",
    },
  ];
  return (
    <section id="how-it-works" className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-[900px] mx-auto">
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center shrink-0">
                  ...
                  {!last && (
                    <div
                      ...
                      style={{
                        minHeight: 40,
                        background: "linear-gradient(180deg, #2563EB, rgba(37,99,235,0.1))",
                      }}
                    />
                  )}
                </div>
                <div className="pt-1.5 pb-10 flex-1 min-w-0">
                  <div
                    className="text-[12px] font-bold uppercase tracking-[0.08em] mb-1.5"
        ...
        <div className="mt-6 flex justify-center">
          <Button href="#demo" variant="secondary" size="lg">
            <PlayCircle size={18} /> Watch 90-Second Demo
          </Button>
        </div>
      </div>
    </section>
...
export function LiveDemoSection() {
  const cards = [
    {
      Icon: AlertCircle, color: "#2563EB", bg: "rgba(37,99,235,0.15)",
      title: "Estimate Request Detected",
      sub: "New inbound lead or unanswered request",
      badge: { t: "Detected", c: "#2563EB", bg: "rgba(37,99,235,0.2)" },
      glow: "blue",
    },
    {
      Icon: Zap, color: "#10B981", bg: "rgba(16,185,129,0.15)",
      title: "Immediate Follow-Up Initiated",
      sub: "Homeowner contacted while still actively looking",
    },
    {
      Icon: MessageCircle, color: "#F59E0B", bg: "rgba(245,158,11,0.15)",
      title: "Homeowner Responds",
      sub: "Engagement confirmed — job details collected",
    },
    {
      Icon: CalendarDays, color: "#2563EB", bg: "rgba(37,99,235,0.15)",
      title: "Inspection Scheduled",
      sub: "Date confirmed, added to your calendar",
    },
    {
      Icon: CheckCircle2, color: "#10B981", bg: "rgba(16,185,129,0.15)",
      title: "Opportunity Recovered",
      sub: "Lead stayed with your company instead of a competitor",
      badge: { t: "Recovered ✓", c: "#10B981", bg: "rgba(16,185,129,0.2)" },
      glow: "green",
    },
  ];
  return (
    <section id="demo" className="py-24 px-6" style={{ background: "linear-gradient(135deg, #0F172A 0%, #1E293B 100%)" }}>
      <div className="max-w-[800px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-12">
          <div
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[13px] font-semibold text-[#93C5FD] mb-6"
            style={{ background: "rgba(37,99,235,0.15)", border: "1px solid rgba(37,99,235,0.3)" }}
          >
            <PlayCircle size={14} />
          ...
          <h2
            className="font-extrabold text-white tracking-[-0.03em] mb-4"
            style={{ fontSize: "clamp(28px, 4vw, 44px)" }}
          >
            See the Workflow in Action
          </h2>
          <p className="text-[17px] text-[#94A3B8]">
            This is the sequence triggered every time a homeowner reaches out.
          </p>
        </motion.div>
        <div className="flex flex-col items-stretch">
          {cards.map((c, i) => (
            <div key={i}>
              ...
              {i < cards.length - 1 && (
                <div
                  className="mx-auto w-[2px] h-6"
                  style={{ background: `linear-gradient(180deg, ${c.color}, rgba(255,255,255,0.05))` }}
                />
              )}
            </div>
          ))}
...
export function BenefitsSection() {
  const items = [
    {
      Icon: CalendarDays, color: "#2563EB", bg: "linear-gradient(135deg, #EFF6FF, #DBEAFE)",
      title: "Book More Inspections",
      body: "Convert a higher share of estimate requests into confirmed appointments without chasing leads manually.",
    },
    {
      Icon: Clock, color: "#10B981", bg: "linear-gradient(135deg, #ECFDF5, #D1FAE5)",
      title: "Respond Faster",
      body: "Reach homeowners earlier in their decision process — before they've already chosen someone else.",
    },
    {
      Icon: Home, color: "#D97706", bg: "linear-gradient(135deg, #FEF3C7, #FDE68A)",
      title: "Recover Missed Opportunities",
      body: "Reduce the share of jobs lost simply because you were on a roof or driving between sites.",
    },
    {
      Icon: Layers, color: "#16A34A", bg: "linear-gradient(135deg, #F0FDF4, #DCFCE7)",
      title: "Less Manual Follow-Up",
      body: "Your team stays focused on running jobs while the follow-up sequence runs in the background.",
    },
    {
      Icon: DollarSign, color: "#2563EB", bg: "linear-gradient(135deg, #EFF6FF, #DBEAFE)",
      title: "More From Existing Leads",
      body: "Capture more value from the leads you're already generating — without adding office overhead.",
    },
    {
      Icon: Heart, color: "#7C3AED", bg: "linear-gradient(135deg, #F5F3FF, #EDE9FE)",
      title: "Stay Top of Mind",
      body: "Consistent, timely engagement helps build trust — even before you've set foot on the property.",
    },
  ];
  return (
    <section className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-[1200px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-14 max-w-[700px] mx-auto">
          ...
          <p className="text-[17px] text-[#64748B]">
            No technology to manage. No learning curve. Just measurable improvements in booked inspections.
          </p>
        </motion.div>
...
export function PilotSection() {
  return (
    <section id="pilot" className="py-24 px-6 bg-white">
      <div
        className="max-w-[900px] mx-auto relative overflow-hidden rounded-3xl text-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10">
          <div
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[13px] font-semibold mb-6"
            style={{
          ...
          <p className="text-[18px] text-[#475569] max-w-[620px] mx-auto leading-[1.6] mb-10">
            We're currently looking for a small number of roofing companies to participate
            in an early pilot — measuring how response speed affects booked inspections
            and recovered revenue opportunities.
          </p>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-10">
            {[
              ...
              <div key={x.t} className="flex items-center gap-2.5">
                <span className="w-9 h-9 rounded-lg grid place-items-center bg-[#ECFDF5]">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Button
              href="mailto:hello@roofrevrecovery.com?subject=Pilot Program Application"
              size="lg"
            >
              See If Faster Follow-Up Can Recover More Opportunities
              <ArrowRight size={18} />
            </Button>
            <Button href="#demo" variant="secondary" size="lg">
              <PlayCircle size={18} /> Watch 90-Second Demo
    ...
    <section id="measure" className="py-24 px-6 bg-[#F8FAFC]">
      <div className="max-w-[1200px] mx-auto">
        <motion.div {...fadeUp} className="text-center mb-12 max-w-[760px] mx-auto">
          ...
          <p className="text-[17px] text-[#64748B]">
            The goal of the pilot is simple: measure whether improved response and engagement
            lead to more booked inspections and revenue opportunities.
          </p>
        </motion.div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {tiles.map((t, i) => (
            <motion.div
              ...
              style={{
                border: t.accent ? "1.5px solid #BFDBFE" : "1px solid #E2E8F0",
        ...
        <motion.div
          {...fadeUp}
          className="mt-10 bg-white rounded-2xl p-7 text-center text-[15px] font-medium text-[#374151]"
          style={{ border: "1px solid #E2E8F0" }}
        >
          At the end of the pilot, you'll have a clear before/after picture —{" "}
          <strong>in your own numbers</strong> — of what faster response did for your business.
        </motion.div>
      </div>
    </section>
  );
  ...
  return (
    <section className="py-24 px-6 bg-white">
      <div className="max-w-[820px] mx-auto">
        ...
        <motion.div
          {...fadeUp}
          className="relative rounded-[20px] p-10 sm:p-12 bg-[#F8FAFC]"
          style={{ border: "1px solid #E2E8F0" }}
        >
          <span
            className="absolute top-4 left-6 leading-none select-none"
            style={{ fontSize: 80, color: "#E2E8F0", fontFamily: "Georgia, serif" }}
          >
            "
          </span>
          <div className="relative space-y-5 text-[17px] sm:text-[18px] text-[#374151] leading-[1.75]">
            ...
            <p>
              The mission is simple: help contractors reduce lost opportunities caused by delayed
              follow-up, and better understand how response speed impacts booked inspections.
            </p>
            <p>
              Rather than making bold claims, we're focused on measuring results and improving
              the process with real businesses.
            </p>
          </div>
          <div
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div
                className="text-[22px] sm:text-[26px] text-[#0F172A] leading-none mb-1.5"
  ...
  const faqs = [
    {
      ...
      a: "Setup typically takes 24–48 hours after our discovery call. We handle everything on our end. You don't need to install anything or change your existing process.",
    },
    {
      q: "Do I need technical knowledge?",
      a: "No. There's nothing for you to learn or manage. You continue running your business the way you do today, and you see booked inspections appear on your calendar.",
    },
    {
      q: "Will this replace my staff?",
      a: "No. This handles the initial follow-up and qualification — the time-sensitive part between when a homeowner reaches out and when your team can respond. Your team still closes the jobs.",
    },
    {
      q: "What happens during the pilot?",
      a: "We run the response and follow-up sequence for your incoming leads. We track every metric — requests received, response times, inspections scheduled — and share a transparent report at the end so you can evaluate the results.",
    },
    {
      q: "How is success measured?",
      a: "We compare your inspection booking rate before and during the pilot. Either you see more inspections booked, or you don't. The data is yours either way.",
    },
    {
      q: "How long is the pilot?",
      a: "The pilot runs for 30 days. That's enough time to see a meaningful change in booked inspections and generate real data — without asking you to commit to anything long-term upfront.",
    },
  ];
            ...
            return (
              <div key={i} style={{ borderBottom: "1px solid #E2E8F0" }}>
                ...
                >
                  ...
                  <span
                    className="text-[#94A3B8] text-[22px] leading-none shrink-0 transition-transform"
...
export function FinalCTA() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #0F172A 0%, #1E293B 100%)", padding: "120px 24px" }}
    >
      <div className="max-w-[800px] mx-auto">
        <motion.div
          {...fadeUp}
          className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[13px] font-semibold text-[#93C5FD] mb-7"
          style={{ background: "rgba(37,99,235,0.15)", border: "1px solid rgba(37,99,235,0.3)" }}
        >
          <BarChart3 size={14} />
          Early Pilot Program
        ...
        <motion.h2
          {...fadeUp}
          className="font-black text-white tracking-[-0.03em] leading-[1.1] mb-6"
          style={{ fontSize: "clamp(32px, 5.4vw, 58px)" }}
        >
          How Many Roofing Opportunities
          <br />
          Might You Be Losing?
        </motion.h2>
        <motion.p
          {...fadeUp}
          className="text-[20px] text-[#94A3B8] leading-[1.6] max-w-[600px] mx-auto mb-9"
        >
        ...
        <motion.div {...fadeUp} className="flex flex-wrap justify-center gap-3">
          <Button href="#pilot" size="xl">
            Apply For Pilot Program <ArrowRight size={20} />
          </Button>
          <Button
            href="#demo"
            variant="secondary"
      ...
      <div className="max-w-[1200px] mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-5 order-2 md:order-3">
          {[
            ...
            <a key={h} href={h} className="text-[13px] text-[#475569] hover:text-[#94A3B8] transition-colors">
              {t}
            </a>
          ))}
        </div>
